 ...
 */
static crc32_t crc32_compute(const char *data, size_t size);
 ...
 * @return The resulting hash
 */
static crc32_t crc32_update(crc32_t initial, const char *data, size_t size);
...
static crc32_t crc32_update(crc32_t value, const char *data, size_t size) {
    assert(data != NULL);
